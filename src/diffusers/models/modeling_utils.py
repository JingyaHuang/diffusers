    ...
    def enable_parallelism(
        ...
        *,
        ...
        if cp_config is not None and tp_config is not None:
            ...
            # often than the CP collectives, so it is the one that wants the closest devices.
            mesh = (
                cp_config.mesh
                or tp_config.mesh
        ...
        # anything is recorded on the model or applied to it. CP is applied before TP below, so a check left to the
